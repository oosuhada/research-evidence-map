...
export function HomeRoute() {
  ...
  return <main className="garden-shell home-shell">
    <header className="masthead"><div className="journal-mark"><Sprout size={20} /><span>Research Evidence Map</span></div><div className="edition home-edition">{text('CUSTOMER RESEARCH WORKBENCH · VERIFICATION-FIRST SYNTHESIS', '고객 리서치 워크벤치 · 검증 우선 AI 종합')}</div><div className="masthead-tools"><div className="masthead-status"><i className="done" />{text('LOCAL-FIRST / TRACEABLE', 'LOCAL-FIRST / 추적 가능')}</div><LanguageToggle /></div></header>
